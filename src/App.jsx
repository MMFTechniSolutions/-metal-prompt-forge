...
const GENRE_FAMILIES = [
  {name:"Années 60-70 (Racines)", nameEn:"60s-70s (Roots)", icon:"",genres:[
    {g:"hard rock",req:"free"},{g:"heavy metal",req:"free"},{g:"punk rock",req:"free"},{g:"proto-metal",req:"forge"},
    {g:"acid rock",req:"forge"},{g:"southern rock",req:"forge"},{g:"occult rock",req:"forge"},{g:"krautrock",req:"forge"},{g:"blues rock",req:"forge"},
  ...
  {name:"Années 80", nameEn:"80s", icon:"",genres:[
    ...
    {g:"bay area thrash",req:"forge"},{g:"teutonic thrash",req:"forge"},{g:"epic doom metal",req:"forge"},{g:"first wave black metal",req:"forge"},{g:"speed thrash",req:"forge"},{g:"gothic rock",req:"forge"},{g:"industrial rock",req:"forge"},
    {g:"youth crew hardcore",req:"forge"},{g:"nyhc",req:"forge"},{g:"straight edge hardcore",req:"forge"},{g:"thrashcore",req:"forge"},{g:"oi!",req:"forge"},
  ]},
  {name:"Années 90", nameEn:"90s", icon:"", genres:[
    ...
    {g:"old school death metal",req:"free"},{g:"death-doom",req:"forge"},{g:"raw black metal",req:"forge"},{g:"symphonic black metal",req:"forge"},{g:"melodic black metal",req:"forge"},{g:"pagan metal",req:"forge"},{g:"gothic doom",req:"forge"},{g:"stoner doom",req:"forge"},{g:"melodic hardcore",req:"forge"},
    {g:"chaotic hardcore",req:"forge"},{g:"screamo",req:"forge"},{g:"emoviolence",req:"forge"},{g:"tough guy hardcore",req:"forge"},{g:"crust punk",req:"forge"},
  ]},
  {name:"Années 2000", nameEn:"2000s", icon:"", genres:[
    ...
    {g:"technical brutal death metal",req:"forge"},{g:"cavernous death metal",req:"forge"},{g:"war metal",req:"forge"},{g:"metallic hardcore",req:"forge"},{g:"cybergrind",req:"forge"},{g:"nu metalcore",req:"forge"},{g:"deathrock",req:"forge"},
    {g:"easycore",req:"forge"},{g:"mosh metal",req:"forge"},{g:"grindviolence",req:"forge"},
  ]},
  {name:"Années 2010", nameEn:"2010s", icon:"", genres:[
    ...
    {g:"downtempo deathcore",req:"free"},{g:"beatdown deathcore",req:"forge"},{g:"thrash revival",req:"forge"},{g:"trad doom revival",req:"forge"},{g:"blackened hardcore",req:"forge"},{g:"dissonant black metal",req:"forge"},
    {g:"modern hardcore",req:"free"},{g:"downtempo hardcore",req:"forge"},{g:"beatdown revival",req:"forge"},
  ]},
  {name:"Années 2020", nameEn:"2020s", icon:"", genres:[
    ...
    {g:"trap metal",req:"forge"},{g:"rage metalcore",req:"forge"},{g:"nu-deathcore",req:"forge"},{g:"hyperpop metalcore",req:"forge"},{g:"dark hardcore",req:"forge"},{g:"neo-crust",req:"forge"},{g:"cinematic deathcore",req:"forge"},
    {g:"hardcore revival",req:"forge"},{g:"rap hardcore",req:"forge"},
  ]},
  {name:"Fusion & Hors-metal (mix)", nameEn:"Fusion & Crossover (mix)", icon:"", genres:[
    ...
    {g:"dungeon synth",req:"forge"},{g:"witch house",req:"forge"},{g:"breakcore",req:"forge"},{g:"phonk",req:"forge"},{g:"noise",req:"forge"},{g:"drill",req:"forge"},
  ]},
];
...
const PRESETS = {
  ...
  // ── PREMIX TESTÉS (blends validés en studio, juillet 2026) — gratuits pour tous ──
  doomgaze:   {label:"Doomgaze Prog ✓",        req:"free", bpm:85,  genres:["doom metal","blackgaze","progressive metal"], drums:["blast beats","half-time groove"], vocals:["tortured screams","black metal shrieks"], mood:["crushing and heavy","melodic and atmospheric"]},
  symphcore:  {label:"Symphonic Deathcore ✓",  req:"free", bpm:170, genres:["deathcore","symphonic metal","black metal"], drums:["blast beats","double bass drumming"], vocals:["guttural death growls","high-pitched screams"], mood:["epic","crushing and heavy"]},
  nudjent:    {label:"Nu-Djent ✓",             req:"free", bpm:130, genres:["nu-metal","djent"], drums:["syncopated rhythms","half-time groove"], vocals:["mid-range harsh vocals"], guitar:["djent-style syncopated riffs","palm muting"], mood:["groovy and headbang-worthy","intense and aggressive"]},
  folkblack:  {label:"Folk Black ✓",           req:"free", bpm:180, genres:["folk metal","black metal"], drums:["blast beats"], vocals:["black metal shrieks"], guitar:["tremolo picking"], mood:["epic","sinister and dark"]},
  deathgroove:{label:"Death Groove ✓",         req:"free", bpm:150, genres:["death metal","groove metal"], drums:["double bass drumming"], vocals:["guttural death growls"], guitar:["palm muting"], mood:["groovy and headbang-worthy","intense and aggressive"]},
};
    ...
    <div style={S.wrap}>
      ...
      {tab==="tuto"&&<div style={S.page}>
        ...
        <div style={S.card}>
          ...
          {[
            {n:"Weirdness",v:"30-65 (ne dépasse pas 65)",d:L("Bas = hook stable. 50 = neutre. Au-dessus de 65, Suno part en vrille : structures incohérentes et dérive hors du genre. Testé.","Low = stable hook. 50 = neutral. Above 65 Suno falls apart: incoherent structures and genre drift. Tested.")},
